...
class AdminUserPhoneController extends WireTablePopupForms
{
    public function __construct()
    {
        ...
        ##
        $this->actions['table'] = "user_phone"; // 테이블 정보

        $this->actions['view_list'] = "jiny-shop-account::admin.user_phone.list";
        $this->actions['view_form'] = "jiny-shop-account::admin.user_phone.form";
